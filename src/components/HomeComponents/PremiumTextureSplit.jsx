          ...
          <div className="w-full max-w-7xl mx-auto px-6 sm:px-8 md:px-12 lg:px-16">
            <div className="text-white max-w-xl md:max-w-2xl lg:max-w-3xl flex flex-col h-full">
              ...
              <h3 className="text-3xl sm:text-3xl md:text-4xl lg:text-[44px] font-bold mb-3 sm:mb-4 md:mb-5 leading-[1.25] text-white tracking-normal">
                Walls That <span className="text-[#432452]">Stand Out!</span>
              </h3>

              <p className="text-base sm:text-base md:text-lg mb-5 sm:mb-6 md:mb-8 text-white/90 font-normal leading-[1.55] sm:leading-[1.55] md:leading-[1.6] max-w-2xl">
