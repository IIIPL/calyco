      ...
      <div className="relative mx-auto max-w-7xl px-6 md:px-12 lg:px-16">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="relative rounded-3xl overflow-hidden shadow-xl group cursor-pointer h-[400px]">
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-8 md:p-10">
              <h3 className="text-3xl md:text-4xl font-bold text-white mb-3 leading-tight">
                Moving in the<br /><span className="text-[#998850]">Right Direction</span>
              </h3>
              <p className="text-white/90 text-sm md:text-base mb-6 leading-relaxed max-w-md">
                Get a personalised plan designed with one goal in mind: helping you feel great in your space with palettes curated for every lifestyle.
              </p>
              <Link
                to="/products"
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-white px-6 py-3 text-sm font-semibold text-[#0F1221] transition hover:bg-white/90 w-fit"
              >
                Explore Products
              </Link>
            </div>
          ...
          <div className="relative rounded-3xl overflow-hidden shadow-xl group cursor-pointer h-[400px]">
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-8 md:p-10">
              <h3 className="text-3xl md:text-4xl font-bold text-white mb-3 leading-tight">
                Paint Smarter,<br /><span className="text-[#998850]">Last Longer</span>
              </h3>
              <p className="text-white/90 text-sm md:text-base mb-6 leading-relaxed max-w-md">
                Choose premium, durable paints in the CALYCO range to protect and enhance every surface with minimal upkeep.
              </p>
              <Link
                to="/colors"
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-white px-6 py-3 text-sm font-semibold text-[#0F1221] transition hover:bg-white/90 w-fit"
