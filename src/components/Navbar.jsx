// ✅ Optimized Navbar with centralized dropdown logic
      ...
      {menuOpen && (
        <div className="fixed inset-0 bg-[#f9f6f2] z-50 flex flex-col overflow-y-auto">
          ...
          <div className="flex flex-col gap-6 text-xl font-medium items-center flex-1 w-full px-4">
            ...
            <InspirationsDropdown isMobile={true} onSelect={() => setMenuOpen(false)} />
            <Link to="#" onClick={() => setMenuOpen(false)} className="text-[#493657] hover:text-[#F0C85A] w-full text-left">Samples</Link>
            <Link to="/about" onClick={() => setMenuOpen(false)} className="text-[#493657] hover:text-[#F0C85A] w-full text-left">About Us</Link>
          </div>
