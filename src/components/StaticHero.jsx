...
const StaticHero = () => {
  return (
    <section className="relative w-full min-h-[70vh] md:min-h-[85vh] overflow-hidden">
      ...
      {/* Content */}
      <div className="relative inset-0 flex items-end md:items-center pb-10 pt-24 sm:pt-32 md:py-0">
        <div className="w-full max-w-7xl mx-auto px-5 sm:px-6 md:px-12 lg:px-16">
          <div className="text-white max-w-xl md:max-w-2xl lg:max-w-3xl space-y-4 sm:space-y-5 flex flex-col">
