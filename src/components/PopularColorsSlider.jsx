        ...
        <div className="w-full px-4 sm:px-6 md:px-8 lg:px-10">
          <div className="flex flex-col xl:flex-row gap-4 lg:gap-6 xl:gap-8 items-center xl:items-center">
            ...
            <div className="w-full xl:w-72 2xl:w-80 flex-shrink-0 text-center xl:text-left">
              ...
              >
                Most Specified.<br />
                <span className="mt-1 sm:mt-2 block">Most Reordered.</span>
              </motion.h2>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                The shades professionals keep coming back to. Available across interior emulsion, textured, and exterior lines. Custom RAL matching on every order.
              </motion.p>
            </div>
