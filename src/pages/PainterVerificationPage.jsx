...
const PainterVerificationPage = () => {
  ...
  return (
    <main className="min-h-screen bg-[#FBF9F6]">
      <SEO
        title="Verified Painters | Calyco 5-Star Painting Service"
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          <div className="max-w-3xl">
            ...
            <p className="text-base sm:text-lg text-white/55 font-light leading-[1.8] mb-8 max-w-2xl">
              We do not simply send a local painter. Calyco assigns trained painting teams who follow our service checklist, safety process and daily reporting system. Every painter you meet has passed 8 verification checks before being assigned to your home.
            </p>
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full border border-white/20 text-white px-7 py-3.5 font-semibold hover:bg-white/10 transition-colors"
              >
      ...
      <section className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-12 sm:py-16">
        <div className="mb-8">
          ...
          <p className="mt-3 text-sm text-[#0F1221]/55 font-light max-w-xl leading-[1.8]">
            Getting on the Calyco network is not easy. Here is exactly what every painter goes through before being assigned to a project.
          </p>
        </div>
        ...
        <div className="rounded-2xl bg-gradient-to-r from-[#0F1221] via-[#1a0b21] to-[#432553] px-6 sm:px-10 py-8 sm:py-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          <div>
            ...
            <p className="text-sm text-white/50 font-light max-w-lg">
              Book a free site visit. A Calyco supervisor visits your property and a verified painter team is assigned before work begins.
            </p>
          </div>
          <div className="flex flex-col gap-3 flex-shrink-0">
            <Link
              to="/get-quote"
              className="inline-flex items-center justify-center gap-2 rounded-full bg-[#F0C85A] text-[#0F1221] px-7 py-3.5 font-bold hover:bg-white transition-colors shadow-lg whitespace-nowrap"
            >
              Book Free Inspection →
            </Link>
            <Link
              to="/services"
              className="inline-flex items-center justify-center gap-2 rounded-full border border-white/20 text-white px-7 py-3 font-semibold hover:bg-white/10 transition-colors whitespace-nowrap"
            >
              Browse services →
            </Link>
          </div>
