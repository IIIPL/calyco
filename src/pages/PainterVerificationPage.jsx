          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full border border-white/20 text-white px-5 py-3 sm:px-7 sm:py-3.5 font-semibold hover:bg-white/10 transition-colors"
              >
