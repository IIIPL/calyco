                          ...
                          {isInteriorLatexProduct && (
                            <>
                              <div className="bg-[#E8F4F8] rounded-lg p-4 text-center">
                                ...
                                <h4 className="font-semibold text-[#493657] text-sm mb-1">Low VOC</h4>
                                <p className="text-xs text-[#493657]/70">Eco-friendly formula</p>
                              </div>
                              <div className="bg-[#F5E6D3] rounded-lg p-4 text-center">
                                <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center mx-auto mb-3">
                                  <FiCheckCircle className="w-6 h-6 text-[#493657]" />
                                </div>
                                <h4 className="font-semibold text-[#493657] text-sm mb-1">Great Coverage</h4>
                                <p className="text-xs text-[#493657]/70">Superior finish</p>
                              </div>
                              <div className="bg-[#D4E4D7] rounded-lg p-4 text-center">
                                <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center mx-auto mb-3">
                                  <FiDroplet className="w-6 h-6 text-[#493657]" />
                                </div>
                                <h4 className="font-semibold text-[#493657] text-sm mb-1">Stain Resistant</h4>
                                <p className="text-xs text-[#493657]/70">Easy to clean</p>
                              </div>
                            </>
                          )}
                          {isExteriorProduct && (
                            <>
                              <div className="bg-[#E8F4F8] rounded-lg p-4 text-center">
                                ...
                                <h4 className="font-semibold text-[#493657] text-sm mb-1">Weather Resistant</h4>
                                <p className="text-xs text-[#493657]/70">All-season protection</p>
                              </div>
                              <div className="bg-[#F5E6D3] rounded-lg p-4 text-center">
                                <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center mx-auto mb-3">
                                  <FiArchive className="w-6 h-6 text-[#493657]" />
                                </div>
                                <h4 className="font-semibold text-[#493657] text-sm mb-1">UV Protection</h4>
                                <p className="text-xs text-[#493657]/70">Fade resistant</p>
                              </div>
                              <div className="bg-[#D4E4D7] rounded-lg p-4 text-center">
                                <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center mx-auto mb-3">
                                  <FiClipboard className="w-6 h-6 text-[#493657]" />
                                </div>
                                <h4 className="font-semibold text-[#493657] text-sm mb-1">Easy Cleanup</h4>
                                <p className="text-xs text-[#493657]/70">Water-based formula</p>
                              </div>
                            </>
                          )}
