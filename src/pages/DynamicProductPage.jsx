...
import { FiTag, FiList, FiCheckCircle, FiDroplet, FiClipboard, FiLayers, FiBox, FiPackage, FiDollarSign, FiType, FiThermometer, FiRepeat, FiClock, FiShield, FiArchive, FiAlertCircle, FiInfo, FiHash, FiCalendar, FiHeart, FiChevronLeft, FiChevronRight, FiExternalLink } from 'react-icons/fi';
...
const EXTERIOR_SIZE_ORDER = ['10L', '20L'];
    ...
    if (foundProduct) {
      ...
      if (finishPricing && typeof finishPricing === "object") {
        ...
        if (sizeKeys.length > 0) {
          setSelectedSize(looksLikeExterior ? '10L' : sizeKeys[0]);
                    ...
                    {product.images && product.images.length > 1 && (
                      <>
                        <button
                          ...
                          className={`absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white shadow-lg flex items-center justify-center transition-all duration-200 hover:bg-[#F0C85A]/10 hover:shadow-xl ${selectedImageIndex === 0
                        ...
                        <button
                          ...
                          className={`absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white shadow-lg flex items-center justify-center transition-all duration-200 hover:bg-[#F0C85A]/10 hover:shadow-xl ${selectedImageIndex === product.images.length - 1
                            ? 'opacity-30 cursor-not-allowed'
                            : 'opacity-100'
                            }`}
                    ...
                    <div className="flex justify-center gap-2 mt-4">
                      {product.images.map((_, idx) => (
                        <button
                          ...
                          className={`w-2.5 h-2.5 rounded-full transition-all duration-200 ${idx === selectedImageIndex
                            ? 'bg-[#F0C85A] w-8'
                    ...
                    >
                      {product.images.map((img, idx) => (
                        <button
                          ...
                          className={`rounded-lg p-2 transition-all duration-200 focus:outline-none flex-shrink-0 w-24 ${selectedImageIndex === idx
                            ? 'bg-[#F0C85A]/10'
            ...
            >
              ...
              {shouldShowMRP && displayMRPValue ? (
                <div className="flex items-baseline gap-3 flex-wrap">
                  ...
                  <span className="text-sm text-[#493657]/60">per {selectedSize || displaySizes[0] || '10L'}</span>
                </div>
              ) : (
                      ...
                      <div className="flex flex-wrap gap-2">
                        {product.finish_type_sheen.map((sheen) => (
                          <button
                            ...
                            className={`px-4 py-2 rounded-lg border transition-all ${selectedSheen === sheen
                              ? "border-[#F0C85A] bg-[#F0C85A]/10 text-[#493657]"
                              : "border-[#493657]/20 text-[#493657]/70 hover:border-[#493657]/40"
                              }`}
                          >
                ...
                <div className="mb-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <button
                      ...
                      className={`relative p-4 rounded-xl border-2 transition-all duration-300 text-left ${selectedColorType === "ready-mixed"
                        ? "border-[#F0C85A] bg-[#F0C85A]/5 shadow-lg"
                        : "border-[#493657]/20 hover:border-[#493657]/40 hover:shadow-md"
                        }`}
                    >
                      <div className="flex items-start gap-3">
                        <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center mt-0.5 ${selectedColorType === "ready-mixed"
                    ...
                    <button
                      ...
                      className={`relative p-4 rounded-xl border-2 transition-all duration-300 text-left ${selectedColorType === "tint-on-demand"
                        ? "border-[#F0C85A] bg-[#F0C85A]/5 shadow-lg"
                        : "border-[#493657]/20 hover:border-[#493657]/40 hover:shadow-md"
                        }`}
                    >
                      <div className="flex items-start gap-3">
                        <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center mt-0.5 ${selectedColorType === "tint-on-demand"
                          ? "border-[#F0C85A] bg-[#F0C85A]"
                          : "border-[#493657]/30"
                          }`}>
