  ...
  return (
    <div className="pt-20 px-6 md:px-12 max-w-7xl mx-auto pb-20">
      <SEO
        ...
        description="Bulk paint supply, quick-buy reorder links, and contractor margin advantage from Calyco."
        url="https://calycopaints.com/contractors"
        ogType="website"
      />
      <h1 className="text-3xl md:text-4xl font-bold text-[#342347]">Contractors</h1>
      <p className="text-gray-600 mt-2">Quick-buy, reorder links, and margin advantage for painting contractors.</p>
      ...
      <div className="mt-10">
        <Link
          to="/contact"
          className="inline-block px-6 py-3 rounded-xl bg-[#493657] text-white font-semibold hover:bg-[#5a4067] transition-colors"
        >
          Contact Sales
        </Link>
      </div>
