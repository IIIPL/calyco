...
const woodPrimerDetail = {
  ...
  slug: "wood-primer",
  image: "/Assets/Product Images/Wood Primer/calyco-wood-primer.webp", 
  images: ["/Assets/Product Images/Wood Primer/calyco-wood-primer.webp"],
  ...
  tagline: "Seals wood for a flawless finish.",
  details: "Calyco Wood Primer is essential for any high-quality woodwork project. Designed to penetrate deep into the grain, it seals pores and blocks resin bleed-through. It provides a uniform, smooth Matt base that significantly improves the coverage and durability of your topcoat enamels or varnishes.",
  ...
  features: [
    ...
    "Prevents Moisture & Resin Bleed",
    "Heavy-Metal Free (Lead Free)",
    "Strong Adhesion for Topcoats",
    "Fast Drying Matt Finish"
  ],
  advantages: [
    "Penetrates and seals wood deeply",
    "Prevents moisture ingress and resin bleed",
    "Improves adhesion of enamel and varnish",
    "Dries quickly to matt finish",
    "Lead-free and safe for use",
    "Compatible with all wood finishes"
  ],
  application: ["Wooden Doors & Windows", "Furniture", "Plywood & MDF", "Exterior Trim"],
  recommended_uses: ["Wooden Frames", "Interior Woodwork", "Cabinets", "Joinery"],
  substrate: ["Softwood", "Hardwood", "Plywood", "MDF"],
  ...
  technicalSpecs: {
    ...
    full_cure: "24 hours",
    application_instructions: "Stir well. Thin 5-10% with mineral turpentine. Apply evenly along grain.",
    shelf_life: "3 Years (Warranty)",
    storage_temp: "Cool, dry place away from direct sunlight",
    cleanup: "Mineral Turpentine",
    preparation_instructions: "Sand (120-180 grit). Clean dust. Ensure moisture <15%. Fill cracks. Wipe oily woods with solvent."
  },
  safety_warnings: {
    hazard_statements: [
    ...
    first_aid: {
        ...
        skin_contact: "Remove contaminated clothing. Rinse skin with water and soap.",
...
const WoodPrimer = () => {
    // Logic for colors - Standard wood primer usually has one base color
    ...
    const calculateMRP = (sizeLabel) => {
        const mrpData = WOOD_PRIMER_MRP[normalizedSelectedSheen];
    ...
    useEffect(() => {
        setProduct(woodPrimerDetail);
        setSelectedSheen(woodPrimerDetail.defaultFinish || "Matt");

        const finishPricing = (woodPrimerDetail.priceByFinish || woodPrimerDetail.price_by_finish || {})["Matt"];
        if (finishPricing && typeof finishPricing === "object") {
            const sizeKeys = Object.keys(finishPricing);
            if (sizeKeys.length > 0) {
                // Ensure 1L or 500ml is selected by default if available
                if (sizeKeys.includes("1L")) {
                    setSelectedSize("1L");
                } else if (sizeKeys.includes("500ml")) {
                    setSelectedSize("500ml");
                } else {
                    setSelectedSize(sizeKeys[0]);
                }
            } else if (woodPrimerDetail.packaging && woodPrimerDetail.packaging.length > 0) {
                setSelectedSize(woodPrimerDetail.packaging[0]);
            }
        } else if (woodPrimerDetail.packaging && woodPrimerDetail.packaging.length > 0) {
            setSelectedSize(woodPrimerDetail.packaging[0]);
        }

        if (Array.isArray(woodPrimerDetail.images) && woodPrimerDetail.images.length > 0) {
            setSelectedImage(woodPrimerDetail.images[0]);
            setSelectedImageIndex(0);
        } else {
            setSelectedImage(woodPrimerDetail.image);
            setSelectedImageIndex(0);
        }
        document.title = woodPrimerDetail.name;
        setLoading(false);
    }, []);
            ...
            >
                                ...
                                <img
                                    ...
                                    onError={(e) => {
                                        ...
                                        if (!e.target.src.includes("placeholder")) {
                                            e.target.src = "https://placehold.co/600x600/F5DEB3/493657?text=Wood+Primer";
                                        }
                                    }}
                                    ...
                                    {product.images.map((_, idx) => (
                                        <button
                                            ...
                                            className={`w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full transition-all duration-200 ${
                                                idx === selectedImageIndex ? 'bg-[#d97706] w-6 sm:w-8' : 'bg-[#493657]/20 hover:bg-[#493657]/40'
                                            }`}
                    ...
                    >
                        ...
                        {totalReviews > 0 && (
                          <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                            ...
                            <span className="text-sm sm:text-base text-[#493657] font-medium cursor-pointer hover:text-[#d97706]" onClick={scrollToReviews}>
                        ...
                        {/* Pricing */}
                        <div>
                            <div className="inline-block bg-[#b45309] text-white px-3 py-1 text-sm font-semibold rounded mb-2">
                                Wood Protection
                            </div>
                            {displayMRPValue ? (
                        ...
                        {Array.isArray(product.features) && product.features.length > 0 && (
                          <div className="my-2">
                            <div className="bg-gradient-to-br from-[#d97706]/10 to-[#493657]/5 rounded-xl border-2 border-[#d97706]/20 p-4 sm:p-6 shadow-md">
                              <ul className="space-y-2 sm:space-y-3">
                                {product.features.map((feature, idx) => (
                                  <li key={idx} className="flex items-start gap-3">
                                    <FiCheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-[#b45309] mt-0.5 flex-shrink-0" />
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 my-3">
                          <div className="bg-[#b45309] rounded-xl p-4 sm:p-5 text-center shadow-lg border border-[#493657]/10 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                            <div className="w-12 h-12 sm:w-14 sm:h-14 bg-white rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-3 shadow-md">
                              <FiLayers className="w-6 h-6 sm:w-7 sm:h-7 text-[#b45309]" />
                            </div>
                        ...
                        <div className="space-y-4 sm:space-y-6">
                                    ...
                                    {displaySizes.map((size) => (
                                      <button
                                        ...
                                        className={`px-3 sm:px-4 py-2 rounded-lg border transition-all text-sm sm:text-base ${
                                          selectedSize === size
                                            ? "border-[#d97706] bg-[#d97706]/10 text-[#493657]"
                            ...
                            <div className="mb-6">
                              ...
                              <motion.button
                                ...
                                className="w-full bg-gradient-to-r from-[#92400e] via-[#b45309] to-[#78350f] text-white font-semibold py-3 sm:py-4 rounded-2xl hover:shadow-2xl hover:shadow-[#92400e]/30 transition-all duration-500 transform hover:-translate-y-1 flex items-center justify-center gap-2 mt-4 text-sm sm:text-base"
                            ...
                            <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-md border border-[#493657]/10">
                                <div className="flex flex-col">
                                    <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-[#b45309] to-[#d97706] rounded-lg sm:rounded-xl flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div className="space-y-3 sm:space-y-4">
                                        {Array.isArray(product.advantages) && product.advantages.length > 0 ? (
                                            product.advantages.map((adv, idx) => (
                                                <div key={idx} className="flex items-start gap-3 p-3 sm:p-4 bg-[#f8fafc] rounded-lg border-l-4 border-[#b45309]">
                                                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-[#b45309] rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div className="mt-8 sm:mt-12 lg:mt-16">
                    <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-[#493657]/10 overflow-hidden">
                        <div className="bg-gradient-to-r from-[#92400e] via-[#b45309] to-[#78350f] text-white p-4 sm:p-6 relative overflow-hidden">
                        ...
                        <div className="grid grid-cols-1 gap-px bg-[#e2e8f0]">
                            {[
                                { label: "Category", value: "Wood Primer", icon: FiTag },
                                ...
                                <div key={idx} className="bg-white p-4 sm:p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0 hover:bg-[#f8fafc] transition-colors">
                                    <div className="flex items-center gap-3">
                                        <spec.icon className="w-4 h-4 sm:w-5 sm:h-5 text-[#b45309]" />
                ...
                <div className="mt-8 sm:mt-12 lg:mt-16">
                    <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-[#493657]/10 overflow-hidden">
                        <div className="bg-gradient-to-r from-[#92400e] via-[#b45309] to-[#78350f] text-white p-4 sm:p-6 text-center relative overflow-hidden">
                            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-white/5 to-black/20"></div>
                    ...
                    <div className="bg-gradient-to-br from-[#f8fafc] to-[#f1f5f9] rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg border border-[#493657]/10">
                        ...
                        <div className="grid grid-cols-1 gap-6 sm:gap-8 md:grid-cols-2">
                            ...
                            <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-lg border border-[#493657]/10 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 group">
                                ...
                                <a
                                    href="/Assets/docs/html-templates/calyco-wood-primer-tds.html"
                                    download
                ...
                >
                    <div className="relative rounded-2xl sm:rounded-3xl bg-gradient-to-br from-[#92400e]/5 via-white to-[#493657]/5 p-6 sm:p-8 md:p-12 shadow-2xl overflow-hidden border border-[#493657]/10">
                        ...
                        <div className="pointer-events-none absolute -top-24 -right-12 w-96 h-96 bg-gradient-to-br from-[#d97706]/20 to-[#92400e]/10 blur-3xl rounded-full" />
                        <div className="pointer-events-none absolute -bottom-32 -left-10 w-80 h-80 bg-gradient-to-tr from-[#92400e]/15 to-[#d97706]/10 blur-3xl rounded-full" />
                        <div className="pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-r from-[#b45309]/10 to-[#78350f]/10 blur-2xl rounded-full" />
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4 sm:gap-8">
                                ...
                                <div className="group bg-white/80 backdrop-blur-lg rounded-xl sm:rounded-2xl border border-[#493657]/20 p-6 sm:p-8 hover:shadow-2xl hover:border-[#b45309] transition-all duration-500 hover:-translate-y-2">
                                    <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-[#b45309] via-[#d97706] to-[#f59e0b] rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                                    ...
                                    <div className="mt-3 sm:mt-4 h-1 w-10 sm:w-12 bg-gradient-to-r from-[#b45309] to-[#b45309]/40 rounded-full group-hover:w-14 sm:group-hover:w-16 transition-all duration-300"></div>
                                </div>
                    ...
                    <div className="relative max-w-6xl mx-auto rounded-2xl sm:rounded-3xl bg-white/90 backdrop-blur-md border border-white/70 shadow-2xl px-4 py-6 sm:px-6 sm:py-10 md:px-10">
                        <div className="flex flex-col gap-4 sm:gap-6 mb-6 sm:mb-10 md:flex-row md:items-center md:justify-between">
                            <div>
                                ...
                                <p className="text-sm md:text-base text-[#493657]/70 mt-2">Finish your wood project with our premium paints.</p>
                            </div>
