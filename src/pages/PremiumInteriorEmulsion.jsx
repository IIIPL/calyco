...
const PremiumInteriorEmulsion = () => {
    ...
    useEffect(() => {
        ...
        setSelectedSheen(interiorLatexPaintDetail.defaultFinish || "Low Sheen Finish");

        const finishPricing = (interiorLatexPaintDetail.priceByFinish || interiorLatexPaintDetail.price_by_finish || {})["Low Sheen Finish"];
