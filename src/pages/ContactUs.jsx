...
// REPLACE THESE THREE with the values from the SAME EmailJS account:
const SERVICE_ID = "service_nztkw4l";
const TEMPLATE_CONTACT = "template_qaobwqf";
const TEMPLATE_CONFIRM = "template_confirmation";
const PUBLIC_KEY = "o3nHktLCZY2hMn6EE"; // your actual Public Key
...
export const ContactUs = () => {
  ...
  const [errors, setErrors] = useState({});
    ...
    // modern init; avoids old cached keys
                ...
                <input type="hidden" name="title" value="Contact Form Submission" />
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input 
                      type="text" id="firstName" name="first_name" value={firstName}
                    ...
                    {errors.firstName && <p className="text-red-600 text-xs mt-1">{errors.firstName}</p>}
                                ...
                                <div>
                                    ...
                                    <input 
                      type="text" id="lastName" name="last_name" value={lastName}
                    ...
                    {errors.lastName && <p className="text-red-600 text-xs mt-1">{errors.lastName}</p>}
                            ...
                            <div>
                                ...
                                <input 
                    type="email" id="email" name="user_email" value={email}
                  ...
                  {errors.email && <p className="text-red-600 text-xs mt-1">{errors.email}</p>}
                            ...
                            <div>
                                ...
                                <textarea 
                    rows="6" id="message" name="message" value={message}
                    ...
                    placeholder="Tell us more about your project or inquiry..." required
                  />
          ...
          >
            ...
            <div className="mb-6 flex items-start">
              <div className="flex-shrink-0 mr-4 text-white bg-[#493657] rounded-full p-2">
                <svg className="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                    d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8m-2 4v7a2 2 0 01-2 2H5a2 2 0 01-2-2v-7m18 0a2 2 0 00-2-2H5a2 2 0 00-2 2m18 0V6a2 2 0 00-2-2H5a2 2 0 00-2 2v6" />
                                </svg>
                            </div>
                            <div>
            ...
            <AddressCard CountrName="India" emailId="info@calycopaints.com" completeAddress="B-37, Sector - 1, Noida NCR, India" />
                    </div>
                    <div className="flex justify-center">
            <AddressCard CountrName="Dubai" emailId="dubai@calycopaints.com" completeAddress="Po Box: 42747 Hamriyah FZ, Sharjah, U.A.E." />
                    </div>
                    <div className="flex justify-center">
            <AddressCard CountrName="Thailand" emailId="thailand@calycopaints.com" completeAddress="75 Ocean Tower - II, 18C Floor Sukhumvit Road, Bangkok, Thailand" />
                    </div>
                    <div className="flex justify-center">
            <AddressCard CountrName="Korea" emailId="korea@calycopaints.com" completeAddress="Regus Gangnam Station 16F, Seocho-dong, Seoul, Korea" />
                    </div>
                    <div className="flex justify-center">
            <AddressCard CountrName="Japan" emailId="japan@calycopaints.com" completeAddress="19F Parks Tower, Nanbanaka, Naniwa-ku, Osaka-shi, Japan" />
                    </div>
                    <div className="flex justify-center">
            <AddressCard CountrName="Turkey" emailId="turkey@calycopaints.com" completeAddress="Karamehmet Mh. Avrupa Serbest Bolgesi, Ergene/Tekirdag, Turkey" />
                    </div>
                    <div className="flex justify-center">
            <AddressCard CountrName="Singapore" emailId="singapore@calycopaints.com" completeAddress="Levels 21 Centennial Tower, 3 Temasek Avenue, Singapore" />
                    </div>
                    <div className="flex justify-center">
            <AddressCard CountrName="Netherlands" emailId="netherlands@calycopaints.com" completeAddress="Zuidplein 126WTC, Toren H, 1077 XV Amsterdam, The Netherlands" />
                    </div>
                    <div className="flex justify-center">
            <AddressCard CountrName="Indonesia" emailId="indonesia@calycopaints.com" completeAddress="Jl. Modern Industri XVIII, Desa Nambo Udik, Cikande, Serang - Banten, Indonesia" />
                    </div>
                </div>
            </div>
        </div>
