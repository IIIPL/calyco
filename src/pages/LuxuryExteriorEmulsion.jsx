...
// MRP pricing for Luxury Exterior Emulsion
const LUXURY_EXTERIOR_MRP = {
  'High Sheen Finish': {
    '1L': 950,
    '4L': 4200,
    '10L': 10100,
...
const LuxuryExteriorEmulsion = () => {
    ...
    const [selectedSheen, setSelectedSheen] = useState("High Sheen Finish");
    ...
    const normalizedSelectedSheen = selectedSheen || product?.defaultFinish || "High Sheen Finish";
    ...
    // Calculate MRP for Luxury Exterior Emulsion
    const calculateMRP = (sizeLabel) => {
        const mrpData = LUXURY_EXTERIOR_MRP[normalizedSelectedSheen];
    ...
    useEffect(() => {
        ...
        setSelectedSheen(exteriorLatexPaintDetail.defaultFinish || "High Sheen Finish");

        const finishPricing = (exteriorLatexPaintDetail.priceByFinish || exteriorLatexPaintDetail.price_by_finish || {})["High Sheen Finish"];
...
export default LuxuryExteriorEmulsion;
