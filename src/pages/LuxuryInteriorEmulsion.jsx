...
// MRP pricing for Luxury Interior Emulsion
const LUXURY_INTERIOR_MRP = {
  'Pearl Finish': {
    '1L': 950,
    '4L': 4200,
    '10L': 10100,
...
const LuxuryInteriorEmulsion = () => {
    ...
    const [selectedSheen, setSelectedSheen] = useState("Pearl Finish");
    ...
    const normalizedSelectedSheen = selectedSheen || product?.defaultFinish || "Pearl Finish";
    ...
    // Calculate MRP for Luxury Interior Emulsion
    const calculateMRP = (sizeLabel) => {
        const mrpData = LUXURY_INTERIOR_MRP[normalizedSelectedSheen];
    ...
    useEffect(() => {
        ...
        setSelectedSheen(interiorLatexPaintDetail.defaultFinish || "Pearl Finish");

        const finishPricing = (interiorLatexPaintDetail.priceByFinish || interiorLatexPaintDetail.price_by_finish || {})["Pearl Finish"];
...
export default LuxuryInteriorEmulsion;
