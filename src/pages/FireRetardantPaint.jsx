...
import { 
  ...
  FiThermometer, FiAlertTriangle, FiMaximize 
} from 'react-icons/fi';
...
const fireRetardantDetail = {
  ...
  image: "/Assets/Product Images/Fire Retardant Paint/calyco-fire-retardant.webp", 
  images: ["/Assets/Product Images/Fire Retardant Paint/calyco-fire-retardant.webp"],
  ...
  tagline: "Advanced fire protection for critical structures.",
  details: "Calyco Fire Retardant Paint is a water-based intumescent acrylic coating designed for life safety. When exposed to extreme heat, the paint expands (intumesces) to create a thick, insulating foam barrier. This layer protects the structural integrity of steel and wood, delaying collapse and preventing the rapid spread of flames.",
  ...
  advantages: [
    "Intumescent protection up to 2 hours fire rating",
    "Delays fire spread and flame propagation",
    "Low smoke emission during fire",
    "Protects structural integrity",
    "Suitable for interior and exterior use",
    "Meets national fire safety standards"
  ],
  application: ["Steel Structures", "Wooden Structures", "Commercial Buildings", "Industrial Facilities"],
  recommended_uses: ["Public Spaces", "Fire-Rated Assemblies", "Beams & Columns", "Warehouses"],
  substrate: ["Steel", "Wood", "Concrete", "Masonry"],
  coats_required: "2-3 coats (Calculated by DFT)",
  coverage: "4-6 sq.ft./L per mm DFT",
  technicalSpecs: {
    product_code: "CAL-FRP-009",
    base_type: "Water-based intumescent acrylic",
    voc_content: "≤ 80 g/L",
    dryingTime: "6-8 hours (Touch Dry)",
    recoatTime: "12-24 hours",
    full_cure: "7 days",
    fire_rating: "Up to 120 minutes",
    application_instructions: "Apply multiple thin coats. Maintain specific wet film thickness. Do not apply below 5°C.",
    shelf_life: "5 Years (Warranty)",
    storage_temp: "Cool, dry place (Protect from freezing)",
    cleanup: "Water",
    preparation_instructions: "Surface must be clean/dry. Steel: remove rust/scale. Wood: sand smooth. Prime if required."
  },
  safety_warnings: {
    hazard_statements: [
      "WARNING: Eye and skin irritant.",
      "May cause respiratory irritation if inhaled in enclosed spaces.",
      "Harmful to aquatic life if liquid paint is poured into drains."
    ],
    precautionary_statements: [
      "Keep out of reach of children.",
      "Wear protective gloves, safety glasses, and mask.",
      "Use in well-ventilated area.",
      "Protect from freezing and direct sunlight."
    ],
    first_aid: {
        inhalation: "Move to fresh air. Get medical attention if symptoms occur.",
        skin_contact: "Wash immediately with soap and plenty of water.",
...
const FireRetardantPaint = () => {
    // Fire retardant paint is typically White/Off-White base
    ...
    useEffect(() => {
        setProduct(fireRetardantDetail);
        setSelectedSheen(fireRetardantDetail.defaultFinish || "Matt");

        const finishPricing = (fireRetardantDetail.priceByFinish || fireRetardantDetail.price_by_finish || {})["Matt"];
        if (finishPricing && typeof finishPricing === "object") {
            const sizeKeys = Object.keys(finishPricing);
            if (sizeKeys.length > 0) {
                setSelectedSize(sizeKeys[0]);
            } else if (fireRetardantDetail.packaging && fireRetardantDetail.packaging.length > 0) {
                setSelectedSize(fireRetardantDetail.packaging[0]);
            }
        } else if (fireRetardantDetail.packaging && fireRetardantDetail.packaging.length > 0) {
            setSelectedSize(fireRetardantDetail.packaging[0]);
        }

        if (Array.isArray(fireRetardantDetail.images) && fireRetardantDetail.images.length > 0) {
            setSelectedImage(fireRetardantDetail.images[0]);
            setSelectedImageIndex(0);
        } else {
            setSelectedImage(fireRetardantDetail.image);
            setSelectedImageIndex(0);
        }
        document.title = fireRetardantDetail.name;
        setLoading(false);
    }, []);
    ...
    const handleAddToCart = () => {
        ...
        setCartPopup({
            ...
            item: {
                name: product.name,
                hex: "#F5F5F5", // Standard white/off-white for fire paint
                colorName: "Base White",
            ...
            >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-16 items-start">
                                ...
                                <img
                                    ...
                                    onError={(e) => {
                                        ...
                                        if (!e.target.src.includes("placeholder")) {
                                            e.target.src = "https://placehold.co/600x600?text=Fire+Retardant+Paint";
                                        }
                                    }}
                    ...
                    >
                        ...
                        {/* Pricing */}
                        <div>
                            <div className="inline-block bg-[#ea580c] text-white px-3 py-1 text-sm font-semibold rounded mb-2">
                                Fire Protection
                            </div>
                            {displayMRPValue ? (
                              ...
                              <ul className="space-y-2 sm:space-y-3">
                                {product.features.map((feature, idx) => (
                                  <li key={idx} className="flex items-start gap-3">
                                    <FiCheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-[#ea580c] mt-0.5 flex-shrink-0" />
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 my-3">
                          <div className="bg-[#ea580c] rounded-xl p-4 sm:p-5 text-center shadow-lg border border-[#493657]/10 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                            <div className="w-12 h-12 sm:w-14 sm:h-14 bg-white rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-3 shadow-md">
                              <FiMaximize className="w-6 h-6 sm:w-7 sm:h-7 text-[#ea580c]" />
                            </div>
                          ...
                          <div className="bg-[#ef4444] rounded-xl p-4 sm:p-5 text-center shadow-lg border border-[#493657]/10 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                            <div className="w-12 h-12 sm:w-14 sm:h-14 bg-white rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-3 shadow-md">
                              <FiClock className="w-6 h-6 sm:w-7 sm:h-7 text-[#ef4444]" />
                            </div>
                        ...
                        <div className="space-y-4 sm:space-y-6">
                                    ...
                                    {displaySizes.map((size) => (
                                      <button
                                        ...
                                        className={`px-3 sm:px-4 py-2 rounded-lg border transition-all text-sm sm:text-base ${
                                          selectedSize === size
                                            ? "border-[#ea580c] bg-[#ea580c]/10 text-[#493657]"
                            ...
                            <div className="mb-6">
                              ...
                              <motion.button
                                ...
                                className="w-full bg-gradient-to-r from-[#ea580c] via-[#c2410c] to-[#9a3412] text-white font-semibold py-3 sm:py-4 rounded-2xl hover:shadow-2xl hover:shadow-[#ea580c]/30 transition-all duration-500 transform hover:-translate-y-1 flex items-center justify-center gap-2 mt-4 text-sm sm:text-base"
                            ...
                            <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-md border border-[#493657]/10">
                                <div className="flex flex-col">
                                    <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-[#ea580c] to-[#f97316] rounded-lg sm:rounded-xl flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div className="space-y-3 sm:space-y-4">
                                        {Array.isArray(product.advantages) && product.advantages.length > 0 ? (
                                            product.advantages.map((adv, idx) => (
                                                <div key={idx} className="flex items-start gap-3 p-3 sm:p-4 bg-[#f8fafc] rounded-lg border-l-4 border-[#ea580c]">
                                                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-[#ea580c] rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div className="mt-8 sm:mt-12 lg:mt-16">
                    <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-[#493657]/10 overflow-hidden">
                        <div className="bg-gradient-to-r from-[#ea580c] via-[#c2410c] to-[#7c2d12] text-white p-4 sm:p-6 relative overflow-hidden">
                        ...
                        <div className="grid grid-cols-1 gap-px bg-[#e2e8f0]">
                            {[
                                { label: "Category", value: "Safety Coating", icon: FiShield },
                                { label: "Fire Rating", value: product.technicalSpecs?.fire_rating, icon: FiClock },
                                ...
                                <div key={idx} className="bg-white p-4 sm:p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0 hover:bg-[#f8fafc] transition-colors">
                                    <div className="flex items-center gap-3">
                                        <spec.icon className="w-4 h-4 sm:w-5 sm:h-5 text-[#ea580c]" />
                ...
                <div className="mt-8 sm:mt-12 lg:mt-16">
                    <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-[#493657]/10 overflow-hidden">
                        <div className="bg-gradient-to-r from-[#ea580c] via-[#c2410c] to-[#7c2d12] text-white p-4 sm:p-6 text-center relative overflow-hidden">
                            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-white/5 to-black/20"></div>
                ...
                >
                    <div className="relative rounded-2xl sm:rounded-3xl bg-gradient-to-br from-[#493657]/5 via-white to-[#F0C85A]/5 p-6 sm:p-8 md:p-12 shadow-2xl overflow-hidden border border-[#493657]/10">
                        ...
                        <div className="pointer-events-none absolute -top-24 -right-12 w-96 h-96 bg-gradient-to-br from-[#ea580c]/20 to-[#493657]/10 blur-3xl rounded-full" />
                        <div className="pointer-events-none absolute -bottom-32 -left-10 w-80 h-80 bg-gradient-to-tr from-[#493657]/15 to-[#ea580c]/10 blur-3xl rounded-full" />
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4 sm:gap-8">
                                ...
                                <div className="group bg-white/80 backdrop-blur-lg rounded-xl sm:rounded-2xl border border-[#493657]/20 p-6 sm:p-8 hover:shadow-2xl hover:border-[#ea580c] transition-all duration-500 hover:-translate-y-2">
                                    <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-[#ea580c] via-[#f97316] to-[#fb923c] rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
...
export default FireRetardantPaint;