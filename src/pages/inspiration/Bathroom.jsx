    ...
    <div className="font-poppins bg-white min-h-screen">
      ...
      <div className="w-full bg-[#f7f7f5] pb-8">
        ...
        <div className="w-full flex justify-center">
          <img src="/Assets/inspiration.png" alt="Bathroom Inspiration" className="w-full max-w-5xl h-64 md:h-96 object-cover rounded-2xl shadow-md border border-gray-100" />
        </div>
      </div>
