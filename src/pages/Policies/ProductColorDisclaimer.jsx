        ...
        <section className={`${sectionPadTight} bg-white max-w-5xl mx-auto px-6 md:px-10 lg:px-12`}>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="rounded-2xl border border-[#0F1221]/10 bg-[#FBF9F6] p-6 shadow-sm">
              ...
              <p className="text-sm text-[#23263a]">
                Customer Support: <a href="tel:+919958966881" className="hover:text-[#D4AF37] font-semibold">+91 99589 66881</a>
              </p>
              <p className="text-xs text-[#23263a]/80 mt-2">Monday - Saturday: 9:00 AM - 7:00 PM IST</p>
            </div>
          </div>
        </section>
