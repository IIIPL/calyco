...
// Left-panel themes — 10 premium palettes cycling every 3s
const HERO_THEMES = [
  // 1. Pearl Grey — rose red headline
  { bg: '#EAEAEF', eyebrow: '#C8102E', text: '#C8102E', para: 'rgba(200,16,46,0.58)',   dark: false, underline: '#C8102E', watermark: '#C8102E', btnBg: '#C8102E', btnText: '#FFFFFF' },
  // 2. Deep Violet + Amber — jewel-tone drama
  ...
  // 3. Champagne Ivory + Walnut — warm luxury
  ...
  // 4. Deep Claret + Blush — sophisticated wine
  ...
  // 5. Sunflower + Navy — bold editorial
  ...
  // 6. Ink Navy + Ice Blue — corporate premium
  ...
  // 7. Sage Linen + Forest — natural premium
  ...
  // 8. Burnt Terracotta + Cream — artisan warmth
  ...
  // 9. Forest Noir + Neon Green — modern luxury
  ...
  // 10. Midnight + Gold — timeless prestige
...
// ── #5 Floating paint speck particles
const SPECK_DEFS = [
...
const HeroFinal = () => {
  ...
  // #1 Left-panel parallax — each content layer moves at a different depth
  ...
  return (
    ...
    >
      ...
      <motion.div
        style={{ y: scrollTextY }}
        className="relative z-10 w-full lg:w-[54%] flex items-center px-6 sm:px-10 lg:px-20 xl:px-28 pt-12 pb-12 lg:py-0 lg:min-h-screen overflow-hidden"
      >
        {/* ── Realistic painted-wall background ────────────────────────── */}

        {/* SVG filter: fractal-noise surface → diffuse point-light → plaster look */}
        <svg className="absolute w-0 h-0 overflow-hidden" aria-hidden="true">
          <defs>
            <filter id="v6-plaster" x="-5%" y="-5%" width="110%" height="110%" colorInterpolationFilters="sRGB">
              {/* Coarse plaster topology */}
              <feTurbulence type="fractalNoise" baseFrequency="0.38 0.22" numOctaves="5" seed="14" result="coarse"/>
              {/* Fine emulsion grain on top */}
              <feTurbulence type="fractalNoise" baseFrequency="1.9 1.5" numOctaves="3" seed="7" result="fine"/>
              {/* Diffuse lighting from top-left (like a window) — gives 3D relief */}
        ...
        {/* 2. SVG 3D plaster surface — blends as soft-light to modulate the base colour */}
        <div
          className="absolute inset-0 z-[1] pointer-events-none"
          style={{ filter: 'url(#v6-plaster)', mixBlendMode: 'soft-light', opacity: 0.38, backgroundColor: '#909090' }}
        />

        {/* 3. Micro grain — emulsion texture at fine scale */}
        <div
        ...
        <div className="relative z-10 w-full max-w-2xl">
          ...
          {/* #1 Parallax layer — headline + #4 character-by-character reveal */}
          <motion.div style={{ x: lHeadX, y: lHeadY }}>
            <h1 className="mb-7 font-light tracking-[-0.025em] text-[2.2rem] sm:text-[3.4rem] lg:text-[clamp(2.8rem,4.4vw,4.8rem)] whitespace-nowrap">
          ...
          {/* #1 Parallax layer — form + #8 3D card tilt */}
          ...
          {/* #1 Parallax layer — trust badges + #7 count-up numbers */}
            ...
            >
              {[
                ...
                <motion.span
                  ...
                  transition={{ duration: 1.4, ease: 'easeInOut' }}
                  style={{ borderWidth: '1px', borderStyle: 'solid' }}
                  className="flex items-center gap-1.5 text-[11px] font-bold rounded-full px-3 py-1 tracking-wide backdrop-blur-sm shadow-[0_2px_10px_rgba(15,18,33,0.08)]"
                >
        ...
        {/* #6 Scroll momentum indicator — thin line grows as user scrolls past hero */}
        <div className="hidden lg:flex absolute bottom-7 left-20 xl:left-28 items-center gap-3 z-10 w-52">
          ...
          <motion.span
            animate={{ color: theme.eyebrow }}
            transition={{ duration: 1.4, ease: 'easeInOut' }}
            className="text-[11px] font-bold tracking-[0.22em] uppercase opacity-50"
          >Scroll</motion.span>
        </div>
      </motion.div>
          ...
          <motion.div style={{ y: scrollImgY }} className="absolute inset-0">
            ...
            >
              <div className="absolute inset-0">
                ...
                {/* #3 Theme colour wash — subtly tints the image to match left panel hue */}
                <motion.div
                  className="absolute inset-0 pointer-events-none"
                  animate={{ backgroundColor: theme.eyebrow }}
                  transition={{ duration: 1.8, ease: 'easeInOut' }}
        ...
        >
          <motion.div style={{ x: badgeX, y: badgeY }}>
            <div className="bg-[#493657] text-white rounded-xl lg:rounded-2xl px-3 py-2.5 lg:px-5 lg:py-4 shadow-2xl shadow-[#493657]/30">
              ...
              <div className="text-[11px] lg:text-[10px] font-semibold text-white/55 tracking-wide">Homes Painted</div>
            </div>
          </motion.div>
        </motion.div>
        ...
        >
          <motion.div style={{ x: ratingX, y: ratingY }}>
            <div className="bg-white rounded-xl lg:rounded-2xl px-3 py-2.5 lg:px-4 lg:py-3.5 shadow-xl border border-gray-100">
              ...
              <div className="text-[11px] lg:text-[11px] text-[#0F1221]/40 font-light mt-0.5 lg:mt-1 uppercase tracking-[0.12em]">Customer Rating</div>
            </div>
          </motion.div>
        </motion.div>
            ...
            <div className="w-full bg-white/90 backdrop-blur-md rounded-xl lg:rounded-2xl p-3.5 lg:p-[18px] shadow-2xl border border-white/40">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 lg:w-7 lg:h-7 rounded-full bg-[#493657] flex items-center justify-center text-white text-[11px] lg:text-[10px] font-bold flex-shrink-0">R</div>
                  <div>
                    <div className="text-[10px] lg:text-[11px] font-bold text-[#0F1221] leading-none mb-0.5">Rakesh M.</div>
                    <div className="text-[11px] lg:text-[11px] text-[#0F1221]/35">Mumbai · Interior Painting</div>
                  </div>
                </div>
