...
const AVAILABLE_SEALER_COLOR_NAMES = ["Chocolate Brown"];
...
const WaterproofingSealer = () => {
    const colorFamilies = useMemo(() => {
        const allowedNames = new Set(AVAILABLE_SEALER_COLOR_NAMES);
        return (colorData || [])
            .map((family) => {
                const label = family.family || family.title || "Color Family";
                const code = family.familyCode || slugify(label);
                const colors = Array.isArray(family.colors)
                    ? family.colors.filter((color) => allowedNames.has(color.name))
                    : [];
                return {
                    code,
                    label,
    ...
    useEffect(() => {
        ...
        const setup = () => {
            ...
            // 🛠️ FIXED: Only set wrapper height on desktop, clear on mobile
            ...
            cleanupFn = () => {
                ...
                resetStyles();
                if (wrapper) {
                    wrapper.style.minHeight = ""; // 🛠️ FIXED: Clear minHeight on cleanup
                }
            };
        };
        ...
        <>
            <div className="min-h-screen bg-white px-3 sm:px-4 md:px-6 xl:px-10">
                ...
                >
                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 my-3">
                                <div className="bg-[#00BCD4] rounded-xl p-4 sm:p-5 text-center shadow-lg border border-[#493657]/10 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                                    ...
                                    <h4 className="font-bold text-white text-sm sm:text-base mb-1 drop-shadow-sm">Waterproof Seal</h4>
                                    <p className="text-xs sm:text-sm text-white/90 font-medium drop-shadow-sm">Complete protection</p>
                                </div>
                                <div className="bg-[#FF9500] rounded-xl p-4 sm:p-5 text-center shadow-lg border border-[#493657]/10 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                                    ...
                                    <p className="text-xs sm:text-sm text-white/90 font-medium drop-shadow-sm">Universal use</p>
                                </div>
                                <div className="bg-[#34C759] rounded-xl p-4 sm:p-5 text-center shadow-lg border border-[#493657]/10 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                                    ...
                                    <p className="text-xs sm:text-sm text-white/90 font-medium drop-shadow-sm">Proven durability</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4 sm:space-y-6">
                                ...
                                {colorFamilies.length > 0 && (
                                    <div className="mb-4">
                                        <h3 className="font-semibold text-[#493657] mb-2 text-sm sm:text-base">Color Family</h3>
                                        <div className="flex flex-wrap gap-2">
                                            {colorFamilies.map((family) => {
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={`px-3 sm:px-4 py-2 rounded-lg border transition-all text-sm sm:text-base ${isActive ? "border-[#F0C85A] bg-[#F0C85A]/10 text-[#493657]" : "border-[#493657]/20 text-[#493657]/70 hover:border-[#493657]/40"}`}
                                                    >
                                                        {family.label}
                                                    </button>
                                                );
                                    ...
                                    <div className="grid grid-cols-1 gap-3">
                                        ...
                                        >
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div className="flex-1">
                                                    <h4 className="font-semibold text-[#493657] mb-1 text-sm sm:text-base">Ready-Mixed Color</h4>
                                        ...
                                        >
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div className="flex-1">
                                                    <h4 className="font-semibold text-[#493657] mb-1 text-sm sm:text-base">Tint-on-Demand</h4>
                                                    <p className="text-xs text-[#493657]/70 leading-relaxed">
                    ...
                    {/* ENHANCED Product Details Section - MOBILE RESPONSIVE WITH FIXED KEY BENEFITS */}
                    <motion.div
                    ...
                    {/* ENHANCED Specifications Section - MOBILE RESPONSIVE */}
                    ...
                    {/* ENHANCED Technical Specifications - MOBILE RESPONSIVE */}
                    <div className="mt-8 sm:mt-12 lg:mt-16">
                        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-[#493657]/10 overflow-hidden">
                    ...
                    {/* ENHANCED Download Documents - MOBILE RESPONSIVE */}
                    <div className="mt-8 sm:mt-12 lg:mt-16">
                        <div className="bg-gradient-to-br from-[#f8fafc] to-[#f1f5f9] rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg border border-[#493657]/10">
                            ...
                            <div className="grid grid-cols-1 gap-6 sm:gap-8 md:grid-cols-2">
                                ...
                                <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-lg border border-[#493657]/10 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 group">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-2 mt-3">
                                        <a href="/Assets/docs/html-templates/waterproofing-sealer-tds.html" download className="flex-1 bg-gradient-to-r from-[#6366f1] to-[#8b5cf6] text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2 sm:gap-3 font-semibold text-sm sm:text-base">
                                            <FiDownload className="w-4 h-4 sm:w-5 sm:h-5" />
                                            Download TDS
                                        </a>
                                        <a href="/Assets/docs/html-templates/waterproofing-sealer-tds.html" target="_blank" rel="noopener noreferrer" className="flex-1 bg-gradient-to-r from-[#6366f1] to-[#8b5cf6] text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2 sm:gap-3 font-semibold text-sm sm:text-base">
                                ...
                                <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-lg border border-[#493657]/10 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 group">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-2 mt-3">
                                        <a href="/Assets/docs/html-templates/waterproofing-sealer-sds.html" download className="flex-1 bg-gradient-to-r from-[#f59e0b] to-[#d97706] text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2 sm:gap-3 font-semibold text-sm sm:text-base">
                                            <FiDownload className="w-4 h-4 sm:w-5 sm:h-5" />
                                            Download SDS
                                        </a>
                                        <a href="/Assets/docs/html-templates/waterproofing-sealer-sds.html" target="_blank" rel="noopener noreferrer" className="flex-1 bg-gradient-to-r from-[#f59e0b] to-[#d97706] text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2 sm:gap-3 font-semibold text-sm sm:text-base">
                                            <FiExternalLink className="w-4 h-4 sm:w-5 sm:h-5" />
                                            View SDS
                                        </a>
                                    </div>
                    ...
                    >
                        <div className="relative rounded-2xl sm:rounded-3xl bg-gradient-to-br from-[#493657]/5 via-white to-[#F0C85A]/5 p-6 sm:p-8 md:p-12 shadow-2xl overflow-hidden border border-[#493657]/10">
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-center text-[#493657]/70 mb-8 sm:mb-12 text-base sm:text-lg">Superior waterproof protection for every surface</p>
                                ...
                                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4 sm:gap-8">
                                    ...
                                    <div className="group bg-white/80 backdrop-blur-lg rounded-xl sm:rounded-2xl border border-[#493657]/20 p-6 sm:p-8 hover:shadow-2xl hover:border-[#F0C85A] transition-all duration-500 hover:-translate-y-2">
                                        ...
                                        <h3 className="text-lg sm:text-xl font-bold text-[#493657] mb-2 sm:mb-3">Waterproof Barrier</h3>
                                        <p className="text-sm text-[#493657]/70 leading-relaxed">Advanced hydrophobic formula creates an impenetrable moisture barrier</p>
                                    ...
                                    {/* Feature 2: Multi-Surface Application */}
                                    <div className="group bg-white/80 backdrop-blur-lg rounded-xl sm:rounded-2xl border border-[#493657]/20 p-6 sm:p-8 hover:shadow-2xl hover:border-[#F0C85A] transition-all duration-500 hover:-translate-y-2">
                                        ...
                                        <h3 className="text-lg sm:text-xl font-bold text-[#493657] mb-2 sm:mb-3">Multi-Surface Use</h3>
                                        <p className="text-sm text-[#493657]/70 leading-relaxed">Compatible with concrete, wood, metal, and masonry surfaces</p>
                                    ...
                                    <div className="group bg-white/80 backdrop-blur-lg rounded-xl sm:rounded-2xl border border-[#493657]/20 p-6 sm:p-8 hover:shadow-2xl hover:border-[#F0C85A] transition-all duration-500 hover:-translate-y-2">
                                        ...
                                        <h3 className="text-lg sm:text-xl font-bold text-[#493657] mb-2 sm:mb-3">Easy Application</h3>
                                        <p className="text-sm text-[#493657]/70 leading-relaxed">Smooth application with brush or roller, professional results guaranteed</p>
                                    ...
                                    <div className="group bg-white/80 backdrop-blur-lg rounded-xl sm:rounded-2xl border border-[#493657]/20 p-6 sm:p-8 hover:shadow-2xl hover:border-[#F0C85A] transition-all duration-500 hover:-translate-y-2">
                                        ...
                                        <h3 className="text-lg sm:text-xl font-bold text-[#493657] mb-2 sm:mb-3">Long-Lasting Shield</h3>
                                        <p className="text-sm text-[#493657]/70 leading-relaxed">Durable protection that withstands weather changes for years</p>
                    ...
                    {/* You Might Also Like Section - MOBILE RESPONSIVE */}
                    <motion.div
                        ...
                        <div className="relative max-w-6xl mx-auto rounded-2xl sm:rounded-3xl bg-white/90 backdrop-blur-md border border-white/70 shadow-2xl px-4 py-6 sm:px-6 sm:py-10 md:px-10">
                            <div className="flex flex-col gap-4 sm:gap-6 mb-6 sm:mb-10 md:flex-row md:items-center md:justify-between">
                                <div>
                                    ...
                                    <p className="text-sm md:text-base text-[#493657]/70 mt-2">Complete your project with interior and exterior paints for comprehensive protection.</p>
                                </div>
